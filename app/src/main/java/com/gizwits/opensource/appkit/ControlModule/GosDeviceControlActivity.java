...
public class GosDeviceControlActivity extends GosControlModuleBaseActivity
	...
	private Switch sw_bool_ir_detect;
	private Switch sw_bool_swith;
	private TextView tv_data_vol_liquid;
	...
	private void initView() {
		...
		sw_bool_ir_detect = (Switch) findViewById(R.id.sw_bool_ir_detect);
		sw_bool_swith = (Switch) findViewById(R.id.sw_bool_swith);
		tv_data_vol_liquid = (TextView) findViewById(R.id.tv_data_vol_liquid);
	}

	private void initEvent() {

		sw_bool_ir_detect.setEnabled(false);
		sw_bool_swith.setOnClickListener(this);
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.sw_bool_swith:
			sendCommand(KEY_SWITH, sw_bool_swith.isChecked());
			break;
		default:
			break;
		}
	...
	protected void updateUI() {
		...
		sw_bool_ir_detect.setChecked(ir_detect);
		sw_bool_swith.setChecked(swith);
		tv_data_vol_liquid.setText(vol_liquid+"");
